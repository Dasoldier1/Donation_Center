...
*/
require $_SERVER['DOCUMENT_ROOT'] .'/Donation_Center/system/connect.php';
return array(
    ...
    'database_user'    => $db_user,          // database user to connect as
    'database_pass'    => $db_pass,              // database user password
    'database_name'    => $db_database,    // name of database to select (you must create this first or use an existing database)
    'database_table'   => 'paypal_donation_captcha_codes', // database table for storing codes, will be created automatically
