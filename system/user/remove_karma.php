	...
	<body>
		<div class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<center><h4><p><?php echo $lang['remove_karma']; ?></p></h4></center>
					<hr />
					<?php 
			// Checks if remove karma is enabled in config.
			if ($karma_enabled == true)
										...
										<div id="loginsuccess">
											...
											<center>
												<form action="<?php if ($use_sandbox == true){ echo $SandboxpayPalURL;} else { echo $payPalURL; } ?>" method="post" class="payPalForm">
													...
													<input type="hidden" name="item_name" value="Remove karma" />

													<!-- Custom field that will be passed to paypal -->
													<input type="hidden" name="custom" value="<?php echo $row['characterName']?>|Karma">
													...
													<select name="amount" style="width: 225px">
														<?php
															...
															if ($karma1_enabled == true)
																{
																	?>
																	<option value="<?php echo $donatekarmaamount1?>"><?php echo $lang['remove_karma_remove'], ' ', $donateremovekarma1, ' ', $lang['remove_karma_karma'], ' ', $currency_code_html, $donatekarmaamount1;?>.00 </option>
																	<?php
																}
															if ($karma2_enabled == true)
																{
																	?>
																	<option value="<?php echo $donatekarmaamount2?>"><?php echo $lang['remove_karma_remove'], ' ', $donateremovekarma2, ' ', $lang['remove_karma_karma'], ' ', $currency_code_html, $donatekarmaamount2;?>.00 </option>
																	<?php
																}
															if ($karma3_enabled == true)
																{
																	?>
																	<option value="<?php echo $donatekarmaamount3?>"><?php echo $lang['remove_karma_remove'], ' ', $donateremovekarma3, ' ', $lang['remove_karma_karma'], ' ', $currency_code_html, $donatekarmaamount3;?>.00 </option>
																	<?php
																}
															if ($karma4_enabled == true)
																{
																	?>
																	<option value="<?php echo $donatekarmaallamount?>"><?php echo $lang['remove_karma_all'], ' ', $currency_code_html, $donatekarmaallamount;?>.00</option>
																	<?php
																}
															?>
													</select>
