	...
	<body>
		<div class="navbar navbar-fixed-top">
			...
			if ($user_role != $row['userRole'])
				{
			?>
				<center><h4><p><?php echo $lang['admin_support_links']; ?></p></h4></center>
					<hr />
						<blockquote>
							<a href="https://github.com/" target='_blank'>Github</a><br>
							<a href="http://www.l2jserver.com/" target='_blank'>L2j server</a><br>
							<a href="http://www.maxcheaters.com/" target='_blank'>MaxCheaters</a><br>
